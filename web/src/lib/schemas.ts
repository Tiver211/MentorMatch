...
export const userSchema = z.object({
  login: z.string().min(3, "Логин должен содержать минимум 3 символа").max(20, "Логин не должен превышать 20 символов"),
  ...
  last_name: z.string().min(2, "Фамилия должна содержать минимум 2 символа").max(50, "Фамилия не должна превышать 50 символов").optional(),
  age: z.number().int().min(0, "Возраст не может быть отрицательным").max(120, "Возраст не может превышать 120 лет").optional(),
  about: z.string().max(500, "Описание не должно превышать 500 символов").optional(),
  contact: z.string().max(100, "Контактная информация не должна превышать 100 символов").optional(),
